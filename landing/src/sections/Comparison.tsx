...
const ROWS: { feature: string; builtin: CellValue; ours: CellValue; commercial: CellValue }[] = [
  {
  ...
  return (
    <section id="comparison" className="py-24 section-padding bg-surface-900 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          {/* Header */}
          <div className="grid grid-cols-4 bg-surface-800/80 border-b border-white/10">
            <div className="p-5 text-sm font-semibold text-surface-400 col-span-1">Feature</div>
            ...
            <div className="p-5 text-center bg-brand-blue/10 border-x border-brand-blue/20">
              ...
              <div className="text-xs text-brand-blue/70 mt-0.5">This extension · Free</div>
            </div>
            <div className="p-5 text-center">
          ...
          {ROWS.map((row, i) => (
            <div
              key={i}
              className={`grid grid-cols-4 border-b border-white/5 last:border-none transition-colors hover:bg-white/[0.02] ${
          ...
          {/* Footer */}
          <div className="grid grid-cols-4 bg-surface-800/60 border-t border-white/10">
        ...
        <div className="flex items-center gap-6 mt-6 justify-center text-xs text-surface-500">
          ...
          <span className="flex items-center gap-1.5"><Minus className="w-3.5 h-3.5 text-brand-amber" /> Partial / paid tier</span>
