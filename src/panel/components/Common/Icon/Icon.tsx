...
export type IconName = 
  | 'record' | 'stop' | 'clear' | 'download' | 'upload'
  | 'search' | 'filter' | 'settings' | 'close' | 'check'
  | 'chevron-right' | 'chevron-down' | 'chevron-up' | 'chevron-left'
  | 'warning' | 'error' | 'info' | 'success'
  | 'tree' | 'flame' | 'timeline' | 'chart'
  | 'component' | 'memo' | 'dom' | 'forward' | 'context'
  | 'lightbulb' | 'spinner' | 'pause' | 'play' | 'trash' | 'copy' | 'refresh';
...
const iconPaths: Record<IconName, string> = {
  // Actions
  record: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z',
  stop: 'M6 6h12v12H6z',
  ...
  // Component types
  component: 'M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zM5 15h14v3H5z',
  ...
  context: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z',
