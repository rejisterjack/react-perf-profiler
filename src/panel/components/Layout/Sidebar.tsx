      ...
      >
        ...
        <div className={styles.header}>
          ...
          <select
            ...
            onChange={(e) => setComponentTypeFilter(e.target.value as 'memoized' | 'unmemoized' | 'all')}
...
const TreeViewPlaceholder: React.FC = () => {
  ...
  const { commits, expandedNodes } = useProfilerStore();
      ...
      {components.map((name, index) => (
        <div
          ...
          style={{ 
            ...
            color: index % 5 === 0 ? 'var(--severity-critical)' : 
                   index % 4 === 0 ? 'var(--severity-warning)' : 
                   'var(--text-primary)'
          }}
        >
...
const EmptyState: React.FC = () => (
  <div className={styles.emptyState}>
    <Icon name="tree" size="xl" className={styles.emptyIcon} />
    <p className={styles.emptyTitle}>No Data</p>
    <p className={styles.emptyText}>
      Start recording to see the component tree
    </p>
  </div>
);
