      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-lg text-surface-400 max-w-2xl mx-auto">
            From basic render counting to AI-powered suggestions and live team sessions — no separate tools, no subscriptions, no paid tiers. Open source and free forever.
          </motion.p>
        </motion.div>
